...
public class InstanceofExam{
	public static void main(String args []){
		...
		if(car instanceof Car){
			System.out.println("car instanceof Car is true");// ture
		}else{
		...
		if(ef instanceof Car){ 
			System.out.println("ef instanceof Car is true");	//ture
		}else{
			System.out.println("ef instanceof Car is false");
		}
		
		if(ex instanceof Car){
			System.out.println("ex instanceof Car is true");	//ture
		}else{
			System.out.println("ex instanceof Car is false");
		}
		
		if(ca instanceof Car){
			System.out.println("ca instanceof Car is true");	//ture
		}else{
