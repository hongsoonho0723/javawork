...
public class StudentService {
	...
	public void init() {
		/*
		 * stArr[0]=new Student(); //stArr[0].name="희정"; //private 이므로 접근불가,
		 * setXxx접근해야한다
		 * 
		 * stArr[0].setName("희정"); stArr[0].setAge(20); stArr[0].setAddr("서울");
		 */
	...
	public void update(String name) {
		...
		for (int i = 0; i < count; i++) {
			...
			if (stArr[i].getName().equals(name)) {
				...
				System.out.print(name + "의 나이를 입력하세요");
				stArr[i].setAge(sc.nextInt());
				System.out.print(name + "의 주소를 입력하세요");
				stArr[i].setAddr(sc.next());
