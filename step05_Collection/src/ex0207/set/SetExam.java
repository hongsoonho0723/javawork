...
public class SetExam {
	...
	Set<String> set = new HashSet<String>(); //TreeSet 요소 ㄱㄴㄷ순 정렬
	...
	public SetExam(String [] args) {
		...
		//set 안에 있는 요소 꺼내기
		/*
		 * Iterator interface는 collection에 있는 모든 자료 구조안에 있는 
		...
		System.out.println("---개선된 for 사용---");
		for(String st: set) {
			System.out.println(st);
		}
		
		//객체 제거
		boolean re = set.remove("효리");
